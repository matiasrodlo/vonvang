...
<?php if (($porto_layout == 'wide-left-sidebar' || $porto_layout == 'wide-right-sidebar' || $porto_layout == 'left-sidebar' || $porto_layout == 'right-sidebar')) : ?>
    <div class="col-md-3 sidebar <?php echo str_replace('wide-', '', $porto_layout) ?>"><!-- main sidebar -->
        <?php
        // show sidebar menu
