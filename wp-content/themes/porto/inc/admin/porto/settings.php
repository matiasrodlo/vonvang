    ...
    class Redux_Framework_porto_settings {
        ...
        public function setSections() {
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id'=>'1',
                        'type' => 'info',
                        'title' => __('Import Dummy Content', 'porto'),
                        'desc' => '<br/><strong>'.__('If import failed, please check your site and click again "Import".', 'porto') . '</strong>',
                        'notice' => false
                    ),
                    ...
                    array(
                        'id'        => '1',
                        'type'      => 'raw',
                        'content'   => (isset($_GET['import_success'])?'<strong>' . __('Successfully Imported!', 'porto') . '</strong><br/><br/>':'').'<a href="'.admin_url('admin.php?page=porto_settings').'&import_sample_content=true" class="button button-primary">' . __('Import', 'porto') . '</a>'
                    ),

                    array(
                        'id'=>'1',
                        'type' => 'info',
                        'title' => __('Import Widgets', 'porto'),
                        'notice' => false
                    ),
                    ...
                    array(
                        'id'        => '1',
                        'type'      => 'raw',
                        'content'   => (isset($_GET['import_widget_success'])?'<strong>' . __('Successfully Imported Widgets!', 'porto') . '</strong><br/><br/>':'').'<a href="'.admin_url('admin.php?page=porto_settings').'&import_widget=true" class="button button-primary">' . __('Import', 'porto') . '</a><br/><br/>'
                    ),

                    array(
                        'id'=>'1',
                        'type' => 'info',
                        'title' => __('Import Master Sliders', 'porto'),
                        'notice' => false
                    ),
                    ...
                    array(
                        'id'        => '1',
                        'type'      => 'raw',
                        'content'   => (isset($_GET['import_masterslider_success'])?'<strong>' . __('Successfully Imported Master Sliders!', 'porto') . '</strong><br/><br/>':'').'<a href="'.admin_url('admin.php?page=porto_settings').'&import_masterslider=true" class="button button-primary">' . __('Import', 'porto') . '</a><br/><br/>'
                    ),

                    array(
                        'id'=>'1',
                        'type' => 'info',
                        'title' => '<strong style="font-size:20px;">'.__('Import Demo', 'porto').'</strong>',
                        'desc' => '<br><strong>'.__('Before import, you should import dummy content, widgets and master sliders.<br/>When import demo, you should wait a few minutes.<br/>Will be change theme options, theme css, plugins css, front end page and blog page.', 'porto').'</strong>',
                        'style' => 'success'
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id'=>'body-bg-gradient',
                        'type' => 'switch',
                        'title' => __('Body Background Gradient', 'porto'),
                        'default' => false,
                        'on' => __('Yes', 'porto'),
                        'off' => __('No', 'porto'),
                    ),
                    ...
                    array(
                        'id'=>'body-bg-gcolor',
                        'type' => 'color_gradient',
                        'title' => __('Body Background Gradient Color', 'porto'),
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => __('Page Background Gradient', 'porto'),
                        'default' => false,
                        'on' => __('Yes', 'porto'),
                        'off' => __('No', 'porto'),
                    ),
                    ...
                    array(
                        ...
                        'type' => 'color_gradient',
                        'title' => __('Page Background Gradient Color', 'porto'),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id'=>'1',
                        'type' => 'info',
                        'title' => __('Background Opacity when banner show below header', 'porto'),
                        'notice' => false
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id'=>'1',
                        'type' => 'info',
                        'title' => __('Menu Custom Content in header type 1, 4, 9', 'porto'),
                        'notice' => false
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id' => "menu-login-pos",
                        'type' => 'button_set',
                        'title' => __('Display Login/Logout Link', 'porto'),
                        'options' => array(
                            '' => __('None', 'porto'),
                    ...
                    array(
                        'id'=>'1',
                        'type' => 'info',
                        'title' => __('If header type is 1 or 4, 13', 'porto'),
                        'notice' => false
                    ),
                    ...
                    array(
                        'id'=>'1',
                        'type' => 'info',
                        'title' => __('If header type is 1 or 4, 9, 13', 'porto'),
                        'notice' => false
                    ),
            ...
            $this->sections[] = array(
                'icon_class' => 'icon',
                'subsection' => true,
                'title' => __('Blog & Post Archive', 'porto'),
                'fields' => array(
                    array(
            ...
            $this->sections[] = array(
                'icon_class' => 'icon',
                'subsection' => true,
                'title' => __('Portfolio Archive', 'porto'),
                'fields' => array(
                    array(
                        'id'=>'portfolio-title',
                        'type' => 'text',
            ...
            $this->sections[] = array(
                'icon_class' => 'icon',
                'subsection' => true,
                'title' => __('Product Archive', 'porto'),
                'fields' => array(
                    array(
