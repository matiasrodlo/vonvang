{
    ...
    "icon-ipad": {
        "url": "<?php echo porto_uri . '/images/logo/apple-touch-icon_72x72.' ?>"
    },
    "icon-ipad-retina": {
    ...
    "switcher-hbg-color": "#006fa4",
    "switcher-link-color": {
        "regular": "#ffffff",
        "hover": "#ffffff"
    },
    "searchform-bg-color": "#006393",
    "searchform-border-color": "#0083c1",
    "searchform-popup-border-color": "#cccccc",
    "searchform-text-color": "#ffffff",
    "searchform-hover-color": "#eeeeee",
    "minicart-icon-color": "#ffffff",
    "minicart-item-color": "#000000",
    "minicart-border-color": "#006393",
    "minicart-bg-color": "#006393",
    "minicart-popup-border-color": "#006fa4",
    "css-code": "",
