{
    ...
    "logo": {
        "url": "<?php echo porto_uri . '/images/logo/logo_red.png' ?>"
    },
    "logo-width": "170",
    "logo-width-wide": "250",
    ...
    "mainmenu-popup-border-color": "#e13b3f",
    ...
    "searchform-hover-color": "#e13b3f",
    "minicart-icon-color": "#e13b3f",
    "minicart-item-color": "#ffffff",
    "minicart-border-color": "#ffffff",
    "minicart-bg-color": "#ffffff",
    "minicart-popup-border-color": "#e13b3f",
    "css-code": "",
    ...
    "menu-block": "",
    "footer-logo": {
        "url": "<?php echo porto_uri . '/images/logo/logo_footer_red.png' ?>"
    },
    "footer-ribbon": "",
