...
add_action('vc_build_admin_page', 'porto_load_history_shortcode');
...
function porto_load_history_shortcode() {
    ...
    vc_map( array(
        'name' => "Porto " . __('History', 'porto-shortcodes'),
        'base' => 'porto_history',
        ...
        'params' => array(
            array(
                'type' => 'textfield',
                'heading' => __('Year', 'porto-shortcodes'),
                'param_name' => 'year',
                'admin_label' => true
            ),
            array(
            ...
            array(
                'type' => 'textarea_html',
                'heading' => __('History', 'porto-shortcodes'),
                'param_name' => 'content',
                "admin_label" => true,
            ),
            $animation_type,
