...
add_action('vc_build_admin_page', 'porto_load_concept_shortcode');
...
function porto_load_concept_shortcode() {
    ...
    vc_map( array(
        ...
        "params" => array(
            ...
            array(
                'type' => 'textfield',
                'heading' => __('Slide #1 Link', 'porto-shortcodes'),
            ...
            array(
                'type' => 'textfield',
                'heading' => __('Slide #2 Link', 'porto-shortcodes'),
            ...
            array(
                'type' => 'textfield',
                'heading' => __('Slide #3 Link', 'porto-shortcodes'),
