...
add_action('vc_build_admin_page', 'porto_load_widget_woo_products_shortcode');
...
function porto_load_widget_woo_products_shortcode() {
    ...
    vc_map(
        array(
            'name' => __( 'Products', 'porto-shortcodes' ) . " " . __("Widget", 'porto-shortcodes' ),
