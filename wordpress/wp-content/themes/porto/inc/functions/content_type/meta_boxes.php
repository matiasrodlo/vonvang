...
function porto_ct_default_meta_skin_boxes() {
    ...
    return array(
        ...
        "page_bg_color"=> array(
            "name" => "page_bg_color",
            "title" => __("Page Background Color", 'porto'),
            "type" => "text",
            "desc" => __("You should input hex color(ex: #ffffff) or 'transparent'.", 'porto')
        ),
        "page_bg_image"=> array(
            "name" => "page_bg_image",
            "title" => __("Page Background Image", 'porto'),
            "type" => "upload"
        ),
        "page_bg_repeat"=> array(
            "name" => "page_bg_repeat",
            "title" => __("Page Background Repeat", 'porto'),
            "type" => "select",
            "options" => $bg_repeat
        ),
        "page_bg_size"=> array(
            "name" => "page_bg_size",
            "title" => __("Page Background Size", 'porto'),
            "type" => "select",
            "options" => $bg_size
        ),
        "page_bg_attchment"=> array(
            "name" => "page_bg_attachment",
            "title" => __("Page Background Attachment", 'porto'),
            "type" => "select",
            "options" => $bg_attachment
        ),
        "page_bg_position"=> array(
            "name" => "page_bg_position",
            "title" => __("Page Background Position", 'porto'),
            "type" => "select",
            "options" => $bg_position
        ),
        // Header Background
