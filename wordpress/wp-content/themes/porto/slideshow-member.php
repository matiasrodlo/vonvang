...
if ($slideshow_type != 'none') : ?>
    ...
    <?php if ($slideshow_type == 'images' && has_post_thumbnail()) : ?>
        <div class="member-image<?php if ($image_count == 1) echo ' single'; ?>">
            <div class="member-slideshow owl-carousel">
                <?php
                ...
                if ($attachment) {
                    ...
                    <div>
                        <div class="img-thumbnail">
                            <div class="inner">
                                <img class="lazyOwl img-responsive" width="<?php echo $attachment['width'] ?>" height="<?php echo $attachment['height'] ?>" data-src="<?php echo $attachment['src'] ?>" alt="<?php echo $attachment['alt'] ?>"<?php if ($porto_settings['member-zoom']) : ?> data-image="<?php echo $attachment['src']; ?>" data-caption="<?php echo $attachment['caption']; ?>"<?php endif; ?> />
