                ...
                if ($attachment) {
                    ...
                    <div>
                        <div class="img-thumbnail">
                            <div class="inner">
                                <img class="lazyOwl img-responsive" width="<?php echo $attachment_large['width'] ?>" height="<?php echo $attachment_large['height'] ?>" data-src="<?php echo $attachment_large['src'] ?>" alt="<?php echo $attachment_large['alt'] ?>"<?php if ($porto_settings['post-zoom']) : ?> data-image="<?php echo $attachment['src'] ?>" data-caption="<?php echo $attachment_large['caption']; ?>"<?php endif; ?> />
