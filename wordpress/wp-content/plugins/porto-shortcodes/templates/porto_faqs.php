<?php
$output = $title = $cat = $post_in = $number = $view_more = $animation_type = $animation_duration = $animation_delay = $el_class = '';
...
if ($posts->have_posts()) {
    ...
    $output = '<div class="porto-faqs wpb_content_element ' . $el_class . '"';
    if ($animation_type)
    ...
    $output .= '</div>' . porto_shortcode_end_block_comment( 'porto_faqs' ) . "\n";
