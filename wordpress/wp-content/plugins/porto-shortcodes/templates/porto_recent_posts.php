<?php
$output = $title = $number = $cat = $show_image = $items_desktop = $items_tablets = $items_mobile = $animation_type = $animation_duration = $animation_delay = $el_class = '';
...
if ($posts->have_posts()) {
    ...
    $output .= '</div>' . porto_shortcode_end_block_comment( 'porto_recent_posts' ) . "\n";
