<?php
$output = $title = $number = $cat = $items_desktop = $items_tablets = $items_mobile = $animation_type = $animation_duration = $animation_delay = $el_class = '';
...
if ($posts->have_posts()) {
    ...
    $output = '<div class="porto-recent-portfolios wpb_content_element ' . $el_class . '"';
    if ($animation_type)
    ...
    $output .= '</div>' . porto_shortcode_end_block_comment( 'porto_recent_portfolios' ) . "\n";
