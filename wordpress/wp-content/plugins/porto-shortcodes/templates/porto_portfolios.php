<?php
$output = $title = $portfolio_layout = $columns = $view = $cat = $post_in = $number = $view_more = $animation_type = $animation_duration = $animation_delay = $el_class = '';
...
if ($posts->have_posts()) {
    ...
    $output .= '</div>' . porto_shortcode_end_block_comment( 'porto_portfolios' ) . "\n";
