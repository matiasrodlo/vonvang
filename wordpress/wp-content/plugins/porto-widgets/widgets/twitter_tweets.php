...
class Porto_Twitter_Tweets_Widget extends WP_Widget {
    ...
    function Porto_Twitter_Tweets_Widget() {
        ...
        $this->WP_Widget('tweets-widget', __('Porto: Twitter Tweets', 'porto-widgets'), $widget_ops, $control_ops);
    }
