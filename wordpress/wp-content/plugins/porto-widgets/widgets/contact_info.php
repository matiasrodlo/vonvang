...
class Porto_Contact_Info_Widget extends WP_Widget {
    ...
    function Porto_Contact_Info_Widget() {
        ...
        $this->WP_Widget('contact-info-widget', __('Porto: Contact Info', 'porto-widgets'), $widget_ops, $control_ops);
    ...
    function widget($args, $instance) {
        ...
        <div class="contact-info">
            ...
            <ul class="contact-details">
                ...
                <?php if ($address) : ?><li><i class="fa fa-map-marker"></i> <strong><?php _e('Dirección', 'porto-widgets') ?>:</strong> <span><?php echo esc_html($address) ?></span></li><?php endif; ?>

                <?php if ($phone) : ?><li><i class="fa fa-phone"></i> <strong><?php _e('Teléfono', 'porto-widgets') ?>:</strong> <span><?php echo esc_html($phone) ?></span></li><?php endif; ?>

                <?php if ($email) : ?><li><i class="fa fa-envelope"></i> <strong><?php _e('Email', 'porto-widgets') ?>:</strong> <span><a href="mailto:<?php echo esc_attr($email) ?>"><?php echo esc_html($email) ?></a></span></li><?php endif; ?>

                <?php if ($working) : ?><li><i class="fa fa-clock-o"></i> <strong><?php _e('Días de trabajo / Horas', 'porto-widgets') ?>:</strong> <span><?php echo esc_html($working) ?></span></li><?php endif; ?>
